...
# ── Sidebar ───────────────────────────────────────────────────────────────────
with st.sidebar:
    st.markdown("<div class='sidebar-title'>✈️ Multi-Agent AI Travel Planner</div>", unsafe_allow_html=True)
    st.markdown("---")
    ...
    for tech in ["🔗 LangGraph", "🧠 Groq · LLaMA 3.3 70B", "🐘 PostgreSQL", "🔍 Tavily Search","Streamlit"]:
...
🤖 LangGraph • Groq • PostgreSQL • Streamlit
</div>
        <div class="hero-title">✈️ Multi-Agent AI Travel Planner</div>
        <div class="hero-sub">
Seven specialized AI agents collaborate to analyze destinations,
search flights and hotels, estimate budgets, monitor weather,
...
# ── Agent pipeline ────────────────────────────────────────────────────────────
AGENT_META = {
    "destination_extractor_agent": ("📍", "Destination Agent"),
    "flight_agent": ("✈️", "Flight Agent"),
    "hotel_agent": ("🏨", "Hotel Agent"),
    "weather_agent": ("🌦️", "Weather Agent"),
    "budget_agent": ("💰", "Budget Agent"),
    "itinerary_agent": ("🗓️", "Itinerary Agent"),
    "final_agent": ("🧠", "Final Report Agent"),
}
